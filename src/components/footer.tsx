        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/" className="text-gray-600 hover:text-teal-500 transition-colors">Home</Link></li>
              <li><Link href="/cars" className="text-gray-600 hover:text-teal-500 transition-colors">Cars</Link></li>
              <li><Link href="/about" className="text-gray-600 hover:text-teal-500 transition-colors">About</Link></li>
              <li><Link href="/contact" className="text-gray-600 hover:text-teal-500 transition-colors">Contact</Link></li>
            </ul>
          </div>
          <div>
